...
<head>
    ...
    <title>Projects - Muhammad Rafi Irfan</title>
    <!-- Favicon-->
            ...
            <div class="container px-5 mb-5">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-11 col-xl-9 col-xxl-8">
                        <?php
                        $sql = "SELECT `name`, `description`, `project_url`, `img_url` FROM projects";
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="p-5">
                                            ...
                                            <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                                href="<?php echo $row["project_url"]; ?>" target="_blank">Learn More &nbsp;&nbsp;<i class="bi bi-arrow-right"></i></a>
                                        </div>
                                        <img class="img-fluid" src="<?php echo $row["img_url"]; ?>"
                                            alt="..." />
                                    </div>
                                </div>
                            </div>
