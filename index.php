...
$sql = "SELECT `lead`, `description`, `img_url` FROM home WHERE id = 1"; 
...
<head>
    ...
    <title>Home - Muhammad Rafi Irfan</title>
    <!-- Favicon-->
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">UI/UX Designer &middot; Fullstack Developer &middot;
                                    Business</div>
                            </div>
                            <div class="fs-3 fw-light text-muted"><?php echo $lead; ?></div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline"><?php echo $description; ?></span></h1>
                            <div
                                ...
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                    href="about.php">Learn More &nbsp;&nbsp;<i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="<?php echo $img_url; ?>" alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
